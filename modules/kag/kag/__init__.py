...
from kag.common.conf import init_env, KAGConstants

# Prefer a colocated kag_config.yaml when present. This keeps CLI entrypoints such as
# `kag mcp-server` aligned with the documented "run from the config directory" flow,
# while still falling back to the original env/server-based bootstrap when no file exists.
