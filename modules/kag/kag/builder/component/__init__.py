...
except ImportError:  # Optional dependency: aliyun-log-python-sdk
    SLSScanner = None
    SLSConsumerScanner = None
...
if SLSScanner is not None:
    __all__.extend(["SLSScanner", "SLSConsumerScanner"])
