...
public class SchedulerCommonService {
  ...
  public void setInstanceFinish(
    ...
    try {
      ...
      log.warn("skip instance cost statistics, instanceId={}", instance.getId(), e);
    }
  ...
  public void costStatistics(SchedulerInstance instance) {
    ...
    if (tokens != null) {
      ...
      // keep full LLM runtime info (prompt/completion/total + prompt traces) for frontend tracing
      extension.put("llmTokenInfo", tokens);
    }
