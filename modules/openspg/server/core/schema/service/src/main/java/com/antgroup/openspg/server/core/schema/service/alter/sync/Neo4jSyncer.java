...
public class Neo4jSyncer extends BaseSchemaSyncer {
  ...
  private int getVectorDimensions(Project project) {
    ...
    try {
      ...
      JSONObject vectorizerConfig = projectConfig.getJSONObject(CommonConstants.VECTORIZER);
      ...
      log.warn(
          "Parse vector dimensions from project config failed, use default. projectId={}",
          project.getId(),
          e);
    }
    return Neo4jCommonUtils.DEFAULT_VECTOR_DIMENSIONS;
